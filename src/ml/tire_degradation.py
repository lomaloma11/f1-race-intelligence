...
def calculate_tire_degradation(compound: str = "SOFT"):
    ...
    """
    # Carrega os dados da Camada Silver (voltas limpas)
    ...
    # Filtra os dados de interesse (Remove voltas lentas/anômalas e filtra o composto)
    ...
    # Prepara X (idade do pneu) e y (tempo da volta)
    ...
    # Extrai o coeficiente (a degradação por volta)
    ...
    # Salvando o modelo dinamicamente
